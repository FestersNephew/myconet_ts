...
import AutomaticScroll from '../AutomaticScroll'; // Import the AutomaticScroll component if needed
...
const Feature2: React.FC = () => {
  ...
  return (
    <section id="feature2" className={styles.feature2}>
      <h2 className={styles.feature2Title}>MycoNets approach to adhere to this vision includes:</h2>
      <AutomaticScroll points={points} interval={interval} /> {/* Add AutomaticScroll component if needed */}
    </section>
  );
};
