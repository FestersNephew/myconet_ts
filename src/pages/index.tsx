        ...
        <main>
          <section className="textbox">
            <div className="textContainer">
              ...
              <p id="textContent">
                We believe that by building a decentralized AI network, we can create a world where AI is used for the
                greater good. Our Team consists of passionate Bittensor OG’s from many different backgrounds who are
